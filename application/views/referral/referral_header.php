              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <!-- <li class="nav-item dropdown"> <a id="messages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-envelope"></i><span class="badge bg-orange" id="textNotification"><?php echo ($textNotification['rows'] > 0)?$textNotification['rows']:"";?></span></a>
                  ...
                  ?>
                    ...
                    <?php }else{?> <li><a rel="nofollow" href="<?php echo base_url('seller/message');?>" class="dropdown-item all-notifications text-center"> <strong>php echo $this->lang->line('no_mess');?></strong></a></li><?php }?>
                  </ul>
                </li> -->
                <!-- Logout    -->
                <li class="nav-item"><a href="<?php echo base_url()."home/logout" ?>" class="nav-link logout"><?php echo $this->lang->line('logout');?><i class="fa fa-sign-out"></i></a></li>
              </ul>
            </div>
          </div>
        </nav>
