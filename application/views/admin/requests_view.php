		...
		<table cellpadding="0" cellspacing="0" border="0" class="product-table sorted_table table-sm table table-striped table-bordered datatables">
			<thead>
				...
				<th align="center"><?php echo $this->lang->line('request_for');?></th>
					<th align="center"><?php echo $this->lang->line('request_name');?></th>
					<th align="center"><?php echo $this->lang->line('additional_info');?></th>
					...
					<?php } else {?>
						<th align="center"><?php echo $this->lang->line('status');?></th>
					<?php } ?>
				</tr>
			</thead>
			<tbody></tbody>
