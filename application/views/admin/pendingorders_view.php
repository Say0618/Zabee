...
<?php if (!$delete) { ?>
    <div>
        <a href="<?php echo base_url("seller/sales/expired") ?>" class="btn btn-default">View Expired Orders</a>
    </div>
    <hr />
<?php } ?>
<div class="card-body">
            ...
            <div class="modal-body" style="padding: 0px 0px 0px 15px;">
                <div class="row" style="padding: 15px;">
                    <div class="panel-body">
                        <input type="hidden" id="order_id" value="">
                        <input type="hidden" id="td_id" value="">
                        <strong style="color:green;font-variant: small-caps;" id="change-message">This order is requested for cancellation, are you sure you want to cancel the request and approve the order?</strong>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
