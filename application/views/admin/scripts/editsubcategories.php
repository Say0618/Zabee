...
$('#myform').validate({
	rules:{
		editsubcategory_name:{ required:true,FirstLetter:true,specialChars:true },
		editdisplay_status:{ required:true },
		editparent_category_id:{ required:true },
	},
	messages:
        {
		  editsubcategory_name:{ required: "Please enter category name" },
		  editdisplay_status:{ required: "Please select an option" },
		  editparent_category_id:{ required: "Please select an option" },
		},
