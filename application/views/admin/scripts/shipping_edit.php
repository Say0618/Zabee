...
$(document).ready(function(){
	...
	$('#myform').validate({
        rules:{
			title:{ required:true,  FirstLetter: true, },
			price:{ required:true, numbersAndDecimalsOnly: true},
			inc_price:{ required:true, numbersAndDecimalsOnly: true},
			free_after:{ required:true, numbersAndDecimalsOnly: true},
			minimum_days:{ required:true,digits: true},
			maximum_days:{ required:true,digits: true,greaterThanEqual:true }
		},
