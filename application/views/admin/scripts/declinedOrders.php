   ...
   var end;
  	var t = $('.datatables').dataTable({
		...
		"ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo base_url('seller/sales/declinedOrders')?>',
            pages: 5 ,// number of pages to cache
            method: "POST"
		} ),
		...
		"columnDefs": [
            ...
            },
			{
                "render": function ( data, type, row ) {
                    if(row.status==1)
					return "<b><div style='color:#4CAF50'>Cancel</div></b>";
            ...
            },
            {
                "render": function ( data, type, row ) {
                    ...
                    var button = "<button  type='button' class='btn btn-primary' data-toggle='modal' onClick='openModal("+row.order_id+")' data-target=''>View</button>";
                    return button;
                }, 
