<?php
	$editurl = base_url()."seller/vendors/editedvendors";		
	$createurl = base_url()."seller/vendors/createvendors";		
?>
<script>
var g_count = 0;
...
var strHtml = '<span class = "vendors-addData"><div class="control-group">'
	...
	<?php
		...
		{
			echo  'strHtml += "<span style = \'color:red;\'>No Areas found.</span>Please <a href = \''.base_url().'seller/areas\'>Add Area</a>";';
		}
	?>
	strHtml +='</div>'
			+'</div>';
