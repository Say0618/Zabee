  ...
  // var end;
  	 t = $('.datatables').dataTable({
		...
		"ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo base_url('seller/users/get_sellers')?>',
            pages: 5 // number of pages to cache
		} ),
		"columnDefs": [
           {
            ...
            },
			{
                "render": function ( data, type, row ) {
					if(row.is_block == "1"){
						var btn='<a href="<?php echo base_url('seller/users/block_user/');?>'+row.seller_id+'/1"  class="btn btn-success">Unblock User</a>';
					}else{
						var btn='<a href="<?php echo base_url('seller/users/block_user/');?>'+row.seller_id+'/2"  class="btn btn-danger">Block User</a>';
					}
                    return btn;
                },
                "targets": 3
			...
			{
                "render": function ( data, type, row ) {
					var btn='<a href="<?php echo base_url('seller/Userdetails/seller_details/');?>'+row.seller_id+'"  class="btn btn-default">Details</a>';
                    return btn;
                },
                "targets": 4
            },
