  ...
  // var end;
  	var t = $('.datatables').DataTable({
		...
		"ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo base_url('seller/product/get_hubx_products')?>',
            pages: 5 // number of pages to cache
		} ),
		"columnDefs": [
            {
            ...
            },
			{
                "render": function ( data, type, row ) {
						var cpro = "";
						//if(row.exists == 0){
							cpro = '<a class="dropdown-item" href="<?php echo base_url("seller/product/create?hubx_id=")?>'+row.hubx_id+'">Create Product</a><div class="dropdown-divider"></div>';
						//}
						return '<div class="dropdown dropdown-padding"><button class="btn btn-secondary smallButton" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cog fa-3" aria-hidden="true"></i></button><div class="dropdown-menu" aria-labelledby="dropdownMenuButton">'+cpro+'</div>';//<a class="dropdown-item" href="<?php //echo base_url("seller/product/inventory_add?hubx_id=")?>'+row.hubx_id+'">Create Inventory</a>;
				},
                "targets": 15
            }
		],
