<?php  
class Requests extends SecureAccess{
	...
	public function index(){
		$this->data['page_name'] 		= 'requests_view';
		$this->data['Breadcrumb_name'] 	= $this->lang->line('requests');
	...
	public function get()
	{
		...
		$this->Requests_Model->getRequests($user_id, $user_type);
