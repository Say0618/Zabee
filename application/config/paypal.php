 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'engr.a_1352880904_biz_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1352880964' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AIiPKg3CJa2IW-Z8ZbtpqREpsLV7A9fbN6mqU-pYtGvgN67Fn0iuzuUB' : 'PRODUCTION_SIGNATURE_GOES_HERE';
